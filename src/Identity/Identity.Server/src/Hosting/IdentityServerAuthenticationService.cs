...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public async Task SignOutAsync(HttpContext context, string scheme, AuthenticationProperties properties)
    {
        ...
        // TODO: try to figure out why this cookie is not being deleted
        if(context.Request.Cookies.TryGetValue(IdentityServerConstants.IdentityCookieName, out var sid))
            context.Response.Cookies.Delete(IdentityServerConstants.IdentityCookieName);               
    }
