...
internal class ConfigureInternalCookieOptions : IConfigureNamedOptions<CookieAuthenticationOptions>
{
    ...
    public void Configure(string name, CookieAuthenticationOptions options)
    {
        if (name == IdentityServerConstants.DefaultCookieAuthenticationScheme)
        {
            ...
            //options.ForwardDefault = IdentityServerConstants.DefaultCookieAuthenticationScheme; // this is needed to ensure the default scheme inside of the cookie middleware is our scheme
            //options.ForwardAuthenticate = IdentityServerConstants.DefaultCookieAuthenticationScheme; // this is needed to ensure the default scheme inside of the cookie middleware is our scheme
        }
