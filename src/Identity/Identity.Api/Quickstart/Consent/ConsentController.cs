...
public class ConsentController : Controller
{
    ...
    private async Task<ProcessConsentResult> ProcessConsent(ConsentInputModel model)
    {
        ...
        if (grantedConsent is not null)
        {
            ...
            result.RedirectUri = model?.ReturnUrl ?? throw new NullReferenceException(nameof(model.ReturnUrl));
        ...
        else
        {
            ...
            var viewModel = await BuildViewModelAsync(model?.ReturnUrl ?? throw new NullReferenceException(nameof(model.ReturnUrl)), model);
    ...
    private ConsentViewModel CreateConsentViewModel(ConsentInputModel? model, string returnUrl, AuthorizationRequest request)
    {
        var vm = new ConsentViewModel
        {
            ...
            ClientName = (request?.Client.ClientName ?? request?.Client.ClientId) ?? string.Empty,
        ...
        if (ConsentOptions.EnableOfflineAccess && (request?.ValidatedResources?.Resources?.OfflineAccess ?? false))
