...
namespace eShop.PublicApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231008181932_Refacoring")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Core.Entities.BasketAggregate.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.Core.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Catalog.Core.Entities.OrderAggregate.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Catalog.Core.Entities.OrderAggregate.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Catalog.Core.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.HasOne("Catalog.Core.Entities.BasketAggregate.Basket", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Catalog.Core.Entities.OrderAggregate.Order", b =>
                {
                    b.OwnsOne("Catalog.Core.Entities.OrderAggregate.Address", "ShipToAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Catalog.Core.Entities.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("Catalog.Core.Entities.OrderAggregate.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("fk_order_items_orders_order_id");

                    b.OwnsOne("Catalog.Core.Entities.OrderAggregate.CatalogItemOrdered", "ItemOrdered", b1 =>
                        {
