...
namespace eShop.PublicApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230908105830_ItemParent")]
    partial class ItemParent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.BasketAggregate.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_catalog_parent_id");

                    b.ToTable("Catalog", (string)null);
                });

            modelBuilder.Entity("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.CatalogAggregate.ItemParent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.OrderAggregate.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.OrderAggregate.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.HasOne("eShop.Catalog.Core.Entities.BasketAggregate.Basket", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogItem", b =>
                {
                    b.HasOne("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogBrand", "CatalogBrand")
                        .WithMany()
                    ...
                    b.HasOne("eShop.Catalog.Core.Entities.CatalogAggregate.CatalogType", "CatalogType")
                        .WithMany()
                    ...
                    b.HasOne("eShop.Catalog.Core.Entities.CatalogAggregate.ItemParent", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .HasConstraintName("fk_catalog_item_parents_parent_id");
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.OrderAggregate.Order", b =>
                {
                    b.OwnsOne("eShop.Catalog.Core.Entities.OrderAggregate.Address", "ShipToAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("eShop.Catalog.Core.Entities.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("eShop.Catalog.Core.Entities.OrderAggregate.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("fk_order_items_orders_order_id");

                    b.OwnsOne("eShop.Catalog.Core.Entities.OrderAggregate.CatalogItemOrdered", "ItemOrdered", b1 =>
                        {
